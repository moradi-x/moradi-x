...
**Laravel Ecosystem**  
Eloquent ORM · Migrations · Seeders · Blade · Policies · Pagination · File Upload · REST API · Authentication · Middleware · Validation · CRUD · Queue
...
**Git Mag** – Tehran  
*Jul 2025 – Nov 2025*  
- Worked with Laravel to build backend features  
- Gained practical experience with Authentication, Middleware, Validation, CRUD, Eloquent ORM, Migrations, and Seeders  
- Deployed applications using Git, Linux, and Apache
...
- **[Tiny MVC](https://github.com/moradi-x/Tiny-MVC)**  
  Lightweight MVC framework built in pure PHP to understand routing, controllers, models, and architecture.

- **[Blog OOP](https://github.com/moradi-x/Blog-OOP)**  
  Object-Oriented PHP blog application focusing on OOP principles and clean code organization.
